...
@ComponentScan({"org.partners.usciitg_prep.terminology.jpa","org.partners.usciitg_prep.fhir"})
@PropertySource("classpath:/org/partners/usciitg_prep/fhir/application.properties")
